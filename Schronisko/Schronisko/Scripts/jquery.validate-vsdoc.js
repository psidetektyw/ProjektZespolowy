...
$.extend($.validator, {
	...
	messages: {
		...
		url: "Wpisz poprawne URL.",
		date: "Wpisz prawidłową datę.",
        dateISO: "Wpisz prawidłową datę (ISO).",
        number: "Wpisz prawidłowy numer.",
		digits: "Wpisz tylko cyfry.",
		creditcard: "Please enter a valid credit card number.",
		equalTo: "Wartości nie są równe.",
        accept: "Wpisz prawidłowe rozszerzenie.",
		maxlength: $.validator.format("Wpisz ponad {0} znaków."),
		minlength: $.validator.format("Wpisz minimum {0} znaków."),
		rangelength: $.validator.format("Wpisz od {0} do {1} znaków."),
		range: $.validator.format("Wpisz wartość między {0} a {1}."),
